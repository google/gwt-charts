...
import com.googlecode.gwt.charts.client.event.RollUpEvent;
...
public class TreeMap extends Widget {
	...
	public final HandlerRef addRollUpHandler(RollUpHandler handler) {
		return addHandler(handler, RollUpEvent.NAME);
	}
	...
	public final void draw(DataSource data, TreeMapOptions options) {
